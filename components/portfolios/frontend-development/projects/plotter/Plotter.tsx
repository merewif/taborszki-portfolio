  ...
  return (
    <div className={styles.card}>
      <div className={styles.featuredImage}>
        <img src='./images/plotter/0.png' alt='' />
              ...
              <div className={styles.galleryContainer}>
                <Carousel>
                  <div className={styles.galleryImage}>
                    <img src='./images/plotter/1.png' alt='' />
                    <p>
                  ...
                  <div>
                    <img src='./images/plotter/2.png' alt='' />
                    <p>
                  ...
                  <div>
                    <img src='./images/plotter/3.png' alt='' />
                    <p>
                  ...
                  <div>
                    <img src='./images/plotter/4.png' alt='' />
                    <p>
                  ...
                  <div>
                    <img src='./images/plotter/5.png' alt='' />
                    <p>
